...
import be.kdg.keepdishesgoing.customerOrder.adapter.in.response.WorkingHourDto;
...
public class RestaurantMapper {
    ...
    public RestaurantCustomerOrderJpaEntity toEntity(Restaurant restaurant) {
        ...
        List<WorkingHourCustomerEmbeddable> hours = restaurant.getWorkingHours().stream()
                .map(wh -> new WorkingHourCustomerEmbeddable(
                        wh.getDayOfWeek(),
                        wh.getOpeningTime(),
                        wh.getClosingTime()
                ))
